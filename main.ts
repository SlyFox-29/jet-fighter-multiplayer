...
info.player4.onLifeZero(function () {
    ...
    if (!(info.player1.hasLife()) && (!(info.player2.hasLife()) && !(info.player3.hasLife()))) {
        game.showLongText("Green Wins!", DialogLayout.Bottom)
        game.over(true)
    } else {
        game.showLongText("Green is Eliminated", DialogLayout.Bottom)
        player4.destroy()
    }
})
info.player3.onLifeZero(function () {
    ...
    if (!(info.player1.hasLife()) && (!(info.player2.hasLife()) && !(info.player4.hasLife()))) {
        game.showLongText("That is a bummer Yellow wins", DialogLayout.Bottom)
        game.over(true)
    } else {
        game.showLongText("Yellow is Toast", DialogLayout.Bottom)
        player3.destroy()
    }
})
...
info.player1.onLifeZero(function () {
    ...
    if (!(info.player2.hasLife()) && (!(info.player3.hasLife()) && !(info.player4.hasLife()))) {
        game.showLongText("Red Wins!", DialogLayout.Bottom)
        game.over(true)
    } else {
        game.showLongText("Red is Eliminated", DialogLayout.Top)
        player1.destroy()
    }
})
...
info.player2.onLifeZero(function () {
    ...
    if (!(info.player1.hasLife()) && (!(info.player3.hasLife()) && !(info.player4.hasLife()))) {
        game.showLongText("Blue Wins!", DialogLayout.Bottom)
        game.over(true)
    } else {
        game.showLongText("Blue Died", DialogLayout.Top)
        player2.destroy()
    }
})
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Enemy, function (sprite, otherSprite) {
    if (sprite == dart1) {
        ...
        info.player3.changeScoreBy(0.9)
    } else {
